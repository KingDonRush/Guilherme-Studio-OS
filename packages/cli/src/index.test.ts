...
const MUTABLE_CLI_DRY_RUN_CASES: Array<{ command: string; args: string[] }> = [
  {
    ...
    args: [
      ...
      "--offer-map-json",
      '[{"profile":"agency","offer":"implementation sprint","evidence_ids":["evd_fake"]}]',
    ],
  },
  ...
  },
  {
    ...
    args: ["outreach", "review", "--subject", "pro_fake", "--channel", "email"],
  },
  {
  ...
  },
  {
    ...
    args: ["proposal", "review", "prp_fake", "--evidence", "evd_fake"],
  },
  {
  ...
  },
  {
    ...
    args: ["proposal", "mark-sent", "prp_fake", "--prepared-action", "act_fake"],
  },
  {
  ...
  },
  {
    ...
    args: ["opportunity", "record-negotiation", "opp_fake", "--change", "Add section"],
  },
  {
    command: "opportunity.close-lost",
    args: ["opportunity", "close-lost", "opp_fake", "--reason", "Budget mismatch"],
  },
  {
